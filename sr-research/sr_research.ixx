...
export namespace sr::research
{
    ...
    void s23_original();
    /*
    void s23_rt_medium_brute_force();
    void s23_rt_medium_greedy();
    void s23_rt_large_brute_force();
    void s23_rt_large_greedy();
    void s23_rt_medium_join_pr5_to_b5();
    void s23_rt_medium_join_pr5_to_b5_join_c4_to_b1();
    */
}
